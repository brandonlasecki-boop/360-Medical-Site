...
export default function ContactHeroSection() {
  ...
  return (
     <section
      ...
      style={{
        backgroundImage: "linear-gradient(to right, rgba(0,0,0,0.5), rgba(0,0,0,0.3)), url('/contactheroimage.jpg')",
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 md:py-0 w-full">
        <div className="max-w-2xl">
          ...
          {/* <p className="text-gray-200 font-heading text-base mb-8 max-w-lg leading-relaxed font-urbanist transition-transform duration-300 hover:scale-102">
            The goal is usually to reach the right audience, attract their
            attention, and get them to take action like buying something,
